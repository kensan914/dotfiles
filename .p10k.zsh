# Generated by Powerlevel10k configuration wizard on 2022-09-14 at 22:15 JST.
...
# 24h time, slanted separators, blurred heads, sharp tails, 2 lines, dotted,
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=083
  # Custom icon.
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='%F{113}◢%f%F{128}┃%f%F{045}◢%f%F{128}┃%f%F{225}◢%f%F{128}┃%f'
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VIINS_CONTENT_EXPANSION='%F{113}❯ %F{231}$'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VIINS_CONTENT_EXPANSION='%F{009}❯ %F{231}$'
